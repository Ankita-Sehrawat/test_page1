...
const Footer = () => {
    return (
        <div className='bg_dark py-5'>
                ...
                <Container className='py-1 '>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className='justify-content-end align-items-center'>
                        <Nav className=" gap-4 align-items-center mt-4 mt-lg-0">
                            ...
                            <Nav.Link href="/" className='fw-normal'>Privacy Policy</Nav.Link>
            ...
            <Container>
                <div className='bg_as h foot_bg p-4 p-sm-5 my-5'>
                    <div className='py-lg-3 my-lg-2 px-lg-2 mx-lg-2'>
                        <Row >
                            <Col xxl={7} lg={6}>
                                <h1 className='text-white ff_sen fs_llg fw-bold text-center text-sm-start'>Subscribe to our news letter to get latest updates and news</h1>
                            </Col>

                            <Col xxl={5} lg={6}>
                                <div className='d-flex gap-4 justify-content-center justify-content-lg-start flex-column flex-sm-row mt-4 mt-lg-0'>
                                    <input className='email_inp clr_ash fs_sm fw-normal' type="email" placeholder='Enter Your Email' />
                                    <button className='ms-2 fs_md fw-bold ff_sen sub_btn bg_sun'>Subscribe</button>
                                </div>
                            </Col>
                        </Row>
                    </div>
                ...
                <div className='d-flex align-items-center justify-content-between flex-column flex-sm-row'>
                    <div>
                        <p className='fs_sm fw-normal text-white opacity-75 text-center text-sm-start'>Finstreet 118 2561 Fintown</p>
                        <p className='fs_sm fw-normal text-white opacity-75 text-center text-sm-start'>Hello@finsweet.com  020 7993 2905</p>
                    </div>

                    <div className='sm_foot mt-4 mt-sm-0'>
                        <a href='https://www.facebook.com/' target='_blank'>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_2013_209)">
                        ...
                        <a href='https://twitter.com/' target='_blank'>
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_2013_211)">
                        ...
                        <a href='https://www.instagram.com/' target='_blank'>
                            <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_2013_213)">
                                    ...
                                    <path d="M13.5652 3.72817C13.5652 4.25943 13.134 4.68755 12.6059 4.68755C12.0746 4.68755 11.6465 4.2563 11.6465 3.72817C11.6465 3.19692 12.0777 2.7688 12.6059 2.7688C13.134 2.7688 13.5652 3.20005 13.5652 3.72817Z" fill="#6D6E76" />
                                </g>
                                <defs>
                                    <clipPath id="clip0_2013_213">
                        ...
                        <a href='https://www.linkedin.com/' target='_blank'>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_2013_218)">
